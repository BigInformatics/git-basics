...
| --- | --- | --- | --- |
| [`git-basics-sql-practice`](https://github.com/BigInformatics/git-basics-sql-practice) | Ready | SQL analysis workflow | edit a query, add notes, update a data dictionary, open a PR |
...
The first course run should use [`git-basics-sql-practice`](https://github.com/BigInformatics/git-basics-sql-practice). It is realistic enough for analysts and statisticians without requiring live database credentials.
