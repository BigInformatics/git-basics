...
![Diagram showing main as the stable shared line and a branch splitting off as a safe workspace for one proposed change.](/git-basics/images/git-branch-workspace.png)
